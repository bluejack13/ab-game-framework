...
public class XMLEngine {
    ...
    public Class<? extends Entity> getClassXMLObject(){
    	Element exmlobj = (Element) doc.getFirstChild();
    	Element efc = (Element)exmlobj.getChildNodes().item(1);
    	if(efc.getNodeName().equals("simpletext")){
    		return SimpleText.class;
    	}else if(efc.getNodeName().equals("animatedsprite")){
    		return AnimatedSprite.class;
    	}
    	return null;
    }
